...
import svg2gcode.simplepath as simplepath
import svg2gcode.simpletransform as simpletransform
import svg2gcode.cubicsuperpath as cubicsuperpath
import svg2gcode.cspsubdiv as cspsubdiv
from svg2gcode.bezmisc import beziersplitatt as bezmisc
...
class line(svgshape):
    ...
    def d_path(self):
        a = [['M ', [self.x1, self.y1]], ['L ', [self.x2, self.y2]]]
        return simplepath.formatPath(a)
